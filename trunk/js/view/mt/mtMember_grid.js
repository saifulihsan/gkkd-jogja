jun.MtReportPenghuniPondok = Ext.extend(Ext.Window, {
        ...
        this.items = [
            {
                ...
                id:'form-MtReportPenghuniPondok',
                labelWidth:100,
                labelAlign:'left',
                layout:'form',
                ref:'formz',
...
//                    },
        ...
        jun.MtReportPenghuniPondok.superclass.initComponent.call(this);
...
//        var sampai = this.trans_date_sampai.hiddenField.dom.value;
        ...
        win.document.write("<html><title>Daftar Penghuni Pondok</title><body>" +
            "<form id='form' method='POST' action='Mahkotrans/MtReport/CetakPenghuniPondok'>" +
    ...
    onbtnPdfclick:function () {
        ...
        //        win.document.getElementById('form').submit();
        //        return;
        Ext.getCmp('form-MtReportPenghuniPondok').getForm().standardSubmit = true;
        Ext.getCmp('form-MtReportPenghuniPondok').getForm().url = 'Mahkotrans/MtReport/CetakPenghuniPondok';
        this.format.setValue('pdf');
        Ext.getCmp('form-MtReportPenghuniPondok').getForm().submit();
    },
    onActivate:function () {
...
jun.MtMemberGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Daftar Penghuni Pondok",
    id:'docs-jun.MtMemberGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
    ...
    initComponent:function () {
        this.store = jun.rztMtMemberbyName;
//        this.bbar = {
//            items:[
//                {
//                    xtype:'paging',
...
//        };
        ...
        jun.rztMtMemberbyName.load();
        jun.MtMemberGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.MtMemberWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        var form = new jun.MtMemberWin({modez:1, id:idz});
        form.show(this);
        form.formz.getForm().loadRecord(this.record);
    },
    deleteRec:function () {
        var rep = new jun.MtReportPenghuniPondok();
        rep.show(this);
//        Ext.MessageBox.confirm('Pertanyaan', 'Apakah anda yakin ingin menghapus data ini?', this.deleteRecYes, this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            waitMsg:'Please Wait',
            url:'Mahkotrans/MtMember/delete/id/' + record.json.id,
            //url: 'index.php/api/MtMember/delete/' + record[0].json.nosjp,
            method:'POST',
