jun.MtBankAccountsWin = Ext.extend(Ext.Window, {
    title:'Kas dan Bank',
    modez:1,
    width:425,
    height:320,
    ...
    initComponent:function () {
        ...
        jun.MtBankAccountsWin.superclass.initComponent.call(this);
    ...
    saveForm:function () {
        ...
        var urlz;
        if (this.modez == 1 || this.modez == 2) {
            urlz = 'Mahkotrans/MtBankAccounts/update/id/' + this.id;
        } else {
            urlz = 'Mahkotrans/MtBankAccounts/create/';
        }
        Ext.getCmp('form-MtBankAccounts').getForm().submit({
            url:urlz,
            timeOut:1000,
            scope:this,
            success:function (f, a) {
                ...
                if (this.modez == 0) {
                    Ext.getCmp('form-MtBankAccounts').getForm().reset();
                }
