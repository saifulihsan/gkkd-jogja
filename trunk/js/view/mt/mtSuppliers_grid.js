jun.MtSuppliersGrid = Ext.extend(Ext.grid.GridPanel, {
    title: "Daftar Pemasok",
    id: 'docs-jun.MtSuppliersGrid',
    iconCls: 'silk-grid',
    viewConfig: {
        forceFit: true
    },
...
//                }
        ...
        jun.MtSuppliersGrid.superclass.initComponent.call(this);
        this.btnAdd.on('Click', this.loadForm, this);
        this.btnEdit.on('Click', this.loadEditForm, this);
//        this.btnDelete.on('Click', this.deleteRec, this);
        this.getSelectionModel().on('rowselect', this.getrow, this);
        jun.rztMtSuppliers.load();
    },
    ...
    loadForm: function() {
        var form = new jun.MtSuppliersWin({modez: 0});
        form.show();
    },
    loadEditForm: function() {
        ...
        var form = new jun.MtSuppliersWin({modez: 1, id: idz});
        form.show(this);
    ...
    deleteRecYes: function(btn) {
        ...
        Ext.Ajax.request({
            url: 'Mahkotrans/MtSuppliers/delete/id/' + record.json.supplier_id,
            //url: 'index.php/api/MtSuppliers/delete/' + record[0].json.nosjp,
            method: 'POST',
