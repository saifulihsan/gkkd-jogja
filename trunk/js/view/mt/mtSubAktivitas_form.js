jun.MtSubAktivitasWin = Ext.extend(Ext.Window, {
    title:'Sub Aktivitas',
    modez:1,
    width:400,
    height:275,
    ...
    initComponent:function () {
        ...
        jun.MtSubAktivitasWin.superclass.initComponent.call(this);
    ...
    saveForm:function () {
        ...
        var urlz;
        if (this.modez == 1 || this.modez == 2) {
            urlz = 'Mahkotrans/MtSubAktivitas/update/id/' + this.id;
        } else {
            urlz = 'Mahkotrans/MtSubAktivitas/create/';
        }
        Ext.getCmp('form-MtSubAktivitas').getForm().submit({
            url:urlz,
            timeOut:1000,
            scope:this,
            success:function (f, a) {
                ...
                if (this.closeForm) {
                    ...
                    if (this.modez == 0) {
                        Ext.getCmp('form-MtSubAktivitas').getForm().reset();
                    }
                }
