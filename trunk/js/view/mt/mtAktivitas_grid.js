jun.MtAktivitasGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Aktivitas",
    id:'docs-jun.MtAktivitasGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
...
//		},
        ...
        /*
         ...
         sortable:true,
         resizable:true,
         dataIndex:'mt_member_id',
         width:100
         },
         {
         header:'mt_sub_aktivitas_id',
         sortable:true,
         resizable:true,
         dataIndex:'mt_sub_aktivitas_id',
         width:100
         },
         {
         header:'users_id',
...
//        };
        ...
        jun.MtAktivitasGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.MtAktivitasWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        Ext.Ajax.request({
            url:'Mahkotrans/MtAktivitas/view/',
            params:{
                id:idz,
            },
            method:'POST',
            success:function (f, a) {
                ...
                var form = new jun.MtAktivitasShowWin({modez:1, id:idz});
    ...
    deleteRec:function () {
        ...
        var form = new jun.MtAktivitasVoidWin({id:record.json.aktivitas_id});
        form.show(this);
    },
})
