jun.MtAktivitasGrupTransGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Aktivitas Grup Anak",
    id:'docs-jun.MtAktivitasGrupTransGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
    ...
    columns:[
        ...
        /*
         ...
         {
         header:'mt_suppliers_supplier_id',
         sortable:true,
         resizable:true,
         dataIndex:'mt_suppliers_supplier_id',
         width:100
         },
         {
         ...
         {
         header:'mt_aktivitas_grup_id',
         sortable:true,
         resizable:true,
         dataIndex:'mt_aktivitas_grup_id',
         width:100
         },
         {
         header:'mt_chart_master_account_code',
         sortable:true,
         resizable:true,
         dataIndex:'mt_chart_master_account_code',
         width:100
         },
         */
    ],
    initComponent:function () {
        this.store = jun.rztMtAktivitasGrupTrans;
//        this.bbar = {
//            items:[
//                {
//                    xtype:'paging',
...
//        };
        ...
        jun.MtAktivitasGrupTransGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.MtAktivitasGrupTransWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        Ext.Ajax.request({
            url:'Mahkotrans/MtAktivitasGrupTrans/view/',
            params:{
                id:idz,
            },
            method:'POST',
            success:function (f, a) {
                ...
                var form = new jun.MtAktivitasGrupShowWin({modez:1, id:idz});
    ...
    deleteRec:function () {
        ...
        var form = new jun.MtAktivitasGrupTransVoidWin({id:record.json.aktivitas_id});
        form.show(this);
    },
})
