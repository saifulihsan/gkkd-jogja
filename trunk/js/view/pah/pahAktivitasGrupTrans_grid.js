jun.PahAktivitasGrupTransGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPahAktivitasGrupTrans, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPahAktivitasGrupTrans.reload(), jun.PahAktivitasGrupTransGrid.superclass.initComponent.call(this), 
    ...
    loadForm: function() {
        var a = new jun.PahAktivitasGrupTransWin({
            modez: 0
        });
        a.show();
    },
    loadEditForm: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(a, c) {
                ...
                var e = d.data[0], f = new jun.PahAktivitasGrupShowWin({
                    modez: 1,
                    id: b
                });
    ...
    deleteRec: function() {
        ...
        var b = new jun.PahAktivitasGrupTransVoidWin({
