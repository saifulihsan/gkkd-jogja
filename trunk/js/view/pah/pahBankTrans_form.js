jun.PahTranferBankWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.rztPahBankAccounts.reload(), jun.PahTranferBankWin.superclass.initComponent.call(this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        a = "PondokHarapan/PahBankTrans/createtransfer/", Ext.getCmp("pah-form-Transfer-bank").getForm().submit({
            url: a,
            timeOut: 1e3,
            scope: this,
            success: function(a, b) {
                ...
                }), Ext.getCmp("pah-form-Transfer-bank").getForm().reset(), jun.rztPahBankTrans.reload(), 
                this.close();
            },
            failure: function (f, a) {
                switch (a.failureType) {
