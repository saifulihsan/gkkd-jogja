jun.PahAnggaranGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPahAnggaran, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.PahAnggaranGrid.superclass.initComponent.call(this), this.btnAdd.on("Click", this.loadForm, this), 
        this.btnEdit.on("Click", this.loadEditForm, this), this.btnDelete.on("Click", this.deleteRec, this), 
        this.getSelectionModel().on("rowselect", this.getrow, this), jun.rztPahAnggaran.load();
    },
    ...
    loadEditForm: function() {
        ...
        var b = a.json.id, c = new jun.PahAnggaranWin({
            modez: 1,
            id: b
        });
    ...
    deleteRecYes: function(a) {
        ...
        Ext.Ajax.request({
            ...
            success: function(a) {
                jun.rztPahAnggaran.reload(), Ext.Msg.alert("Anggaran", "Anggaran berhasil dihapus.");
            },
