jun.PahAnggaranDetilGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPahAnggaranDetil, this.tbar = {
            xtype: "toolbar",
            items: [ {
                xtype: "button",
                iconCls: "asp-pay_add",
        ...
        }, jun.PahAnggaranDetilGrid.superclass.initComponent.call(this), this.btnAdd.on("Click", this.loadForm, this), 
    ...
    loadForm: function() {
        var a = new jun.PahAnggaranDetilWin({
            modez: 0
        });
        a.show();
    },
    loadEditForm: function() {
        ...
        var b = a.data.pah_chart_master_account_code, c = new jun.PahAnggaranDetilWin({
            modez: 1,
            id: b
        });
    ...
    deleteRecYes: function(a) {
        ...
        var c = this.store.find("pah_chart_master_account_code", b.data.pah_chart_master_account_code);
