jun.PahSubAktivitasWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.rztPahChartMaster.reload(), jun.PahSubAktivitasWin.superclass.initComponent.call(this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokHarapan/PahSubAktivitas/update/id/" + this.id : a = "PondokHarapan/PahSubAktivitas/create/", 
        Ext.getCmp("form-PahSubAktivitas").getForm().submit({
            ...
            success: function(a, b) {
                ...
                this.modez == 0 && Ext.getCmp("form-PahSubAktivitas").getForm().reset()), this.btnDisabled(!1);
            },
