jun.PahBankAccountsGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPahBankAccounts, this.tbar = {
            xtype: "toolbar",
            items: [ {
                xtype: "button",
        ...
        }, jun.PahBankAccountsGrid.superclass.initComponent.call(this), this.btnAdd.on("Click", this.loadForm, this), 
        this.btnEdit.on("Click", this.loadEditForm, this), this.getSelectionModel().on("rowselect", this.getrow, this), 
        this.on("activate", this.onActivate, this), jun.rztPahBankAccounts.load();
    },
    onActivate: function() {},
    ...
    loadForm: function() {
        var a = new jun.PahBankAccountsWin({
            modez: 0
        });
        a.show();
    },
    loadEditForm: function() {
        ...
        var b = a.json.id, c = new jun.PahBankAccountsWin({
            modez: 1,
            id: b
        });
    ...
    deleteRecYes: function(a) {
        ...
        Ext.Ajax.request({
            url: "PondokHarapan/PahBankAccounts/delete/id/" + b.json.id,
            method: "POST",
