jun.PeAktivitasWin = Ext.extend(Ext.Window, {
    title: "Aktivitas",
    modez: 1,
    width: 450,
    height: 360,
    ...
    initComponent: function() {
        ...
        }, jun.rztPeBankAccounts.reload(), jun.rztPeSuppliers.reload(), jun.rztPeMemberbyName.reload(), 
        jun.rztPeSubAktivitas.reload(), jun.PeAktivitasWin.superclass.initComponent.call(this), 
    ...
    onFocusAnak: function() {
        jun.rztPeMemberbyName.FilterData();
    },
    ...
    onWinClose: function() {
        jun.rztPeBankAccounts.clearFilter(), jun.rztPeSuppliers.clearFilter(), jun.rztPeMemberbyName.clearFilter(), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeAktivitas/update/id/" + this.id : a = "PondokEfata/PeAktivitas/create/", 
        Ext.getCmp("form-PeAktivitas").getForm().submit({
            url: a,
            timeOut: 1e3,
            scope: this,
            success: function(a, b) {
                ...
                }), this.modez == 0 && Ext.getCmp("form-PeAktivitas").getForm().reset(), this.closeForm && this.close(), 
                this.btnDisabled(!1);
            },
...
}), jun.PeAktivitasShowWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeAktivitasShowWin.superclass.initComponent.call(this), this.btnCancel.on("click", this.onbtnCancelclick, this);
    },
    onbtnCancelclick: function() {
        this.close();
    }
}), jun.PeAktivitasVoidWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeAktivitasVoidWin.superclass.initComponent.call(this), this.btnProses.on("click", this.onbtnProsesclick, this), 
    ...
    onbtnProsesclick: function() {
        this.btnDisabled(!0);
        var a = Ext.getCmp("form-PeAktivitasVoid").getForm();
        Ext.getCmp("form-PeAktivitasVoid").getForm().submit({
            url: "PondokEfata/PeAktivitas/delete/",
            params: {
                id: this.id
            },
            method: "POST",
            ...
            success: function(a, b) {
                ...
                Ext.MessageBox.show({
                    ...
                    buttons: Ext.MessageBox.OK,
                    icon: Ext.MessageBox.INFO
                }), Ext.getCmp("form-PeAktivitasVoid").getForm().reset(), this.btnDisabled(!1), 
                jun.rztPeAktivitas.reload(), this.close();
            },
            failure: function (f, a) {
                switch (a.failureType) {
                    case Ext.form.Action.CLIENT_INVALID:
