...
//                    },
        ...
        jun.PeReportPenghuniPondok.superclass.initComponent.call(this);
...
//        var sampai = this.trans_date_sampai.hiddenField.dom.value;
        ...
        win.document.write("<html><title>Daftar Penghuni Pondok</title><body>" +
            "<form id='form' method='POST' action='PondokEfata/PeReport/CetakPenghuniPondok'>" +
    ...
    onbtnPdfclick:function () {
        ...
        //        win.document.getElementById('form').submit();
        //        return;
        Ext.getCmp('form-PeReportPenghuniPondok').getForm().standardSubmit = true;
        Ext.getCmp('form-PeReportPenghuniPondok').getForm().url = 'PondokEfata/PeReport/CetakPenghuniPondok';
        this.format.setValue('pdf');
        Ext.getCmp('form-PeReportPenghuniPondok').getForm().submit();
    },
    onActivate:function () {
...
//            ]
    ...
    deleteRec:function () {
        var rep = new jun.PeReportPenghuniPondok();
        rep.show(this);
