jun.PeKasKeluarWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.rztPeBankAccounts.reload(), jun.rztPeSuppliers.reload(), jun.rztPeChartMaster.reload(), 
        jun.PeKasKeluarWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    onWinClose: function() {
        jun.rztPeBankAccounts.clearFilter(), jun.rztPeChartMaster.clearFilter(), jun.rztPeSuppliers.clearFilter();
    },
    onActivate: function() {
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeKasKeluar/update/id/" + this.id : a = "PondokEfata/PeKasKeluar/create/", 
        Ext.getCmp("form-PeKasKeluar").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && (Ext.getCmp("form-PeKasKeluar").getForm().reset(), this.btnDisabled(!1)), 
                jun.rztPeKasKeluar.reload(), this.closeForm && this.close();
            },
    ...
    initComponent: function() {
        ...
        }, jun.PeKasKeluarShowWin.superclass.initComponent.call(this), this.btnCancel.on("click", this.onbtnCancelclick, this);
    },
    onbtnCancelclick: function() {
        this.close();
    }
    ...
    initComponent: function() {
        ...
        }, jun.PeKasKeluarVoidWin.superclass.initComponent.call(this), this.btnProses.on("click", this.onbtnProsesclick, this), 
    ...
    onbtnProsesclick: function() {
        this.btnDisabled(!0);
        var a = Ext.getCmp("form-PeKasKeluarVoid").getForm();
        Ext.getCmp("form-PeKasKeluarVoid").getForm().submit({
            ...
            success: function(a, b) {
                ...
                Ext.MessageBox.show({
                    ...
                    buttons: Ext.MessageBox.OK,
                    icon: Ext.MessageBox.INFO
                }), Ext.getCmp("form-PeKasKeluarVoid").getForm().reset(), jun.rztPeKasKeluar.reload(), 
                this.close();
            },
            failure: function (f, a) {
                switch (a.failureType) {
