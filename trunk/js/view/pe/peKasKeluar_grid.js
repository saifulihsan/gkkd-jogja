jun.PeKasKeluarGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPeKasKeluar, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPeKasKeluar.reload(), jun.PeKasKeluarGrid.superclass.initComponent.call(this), 
    ...
    loadEditForm: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(a, c) {
                ...
                var e = d.data[0], f = new jun.PeKasKeluarShowWin({
                    modez: 1,
                    id: b
                });
    ...
    deleteRec: function() {
        ...
        var b = new jun.PeKasKeluarVoidWin({
