...
jun.PeKasAwalGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent:function () {
        ...
        jun.PeKasAwalGrid.superclass.initComponent.call(this);
        this.store.load();
    },
...
jun.PeAnggaranWin = Ext.extend(Ext.Window, {
    ...
    initComponent:function () {
        ...
        jun.rztPeAnggaranDetil.removeAll();
        jun.rztPeChartMaster.reload();
        jun.PeAnggaranWin.superclass.initComponent.call(this);
        ...
        if (this.modez == 1 || this.modez == 2) {
            jun.rztPeAnggaranDetil.proxy = new Ext.data.HttpProxy({ url:'PondokEfata/PeAnggaranDetil/index/id/' + this.id + '/?output=json' });
    ...
    onbtnDetilclick:function () {
        ...
        win.show();
        //        var detil = new jun.PeKasAwalGrid();
        //        detil.show(this);
    },
    ...
    saveForm:function () {
        ...
        var urlz;
        if (this.modez == 1 || this.modez == 2) {
            urlz = 'PondokEfata/PeAnggaran/update/id/' + this.id;
        } else {
            Ext.Ajax.request({
                //
                url:'PondokEfata/PeAnggaran/IsPeriodeExist/',
            ...
            urlz = 'PondokEfata/PeAnggaran/create/';
        }
        Ext.getCmp('form-PeAnggaran').getForm().submit({
            url:urlz,
            params:{
            ...
            success:function (f, a) {
                ...
                if (this.modez == 0) {
                    ...
                    Ext.getCmp('form-PeAnggaran').getForm().reset();
                    this.btnDisabled(false);
                }
