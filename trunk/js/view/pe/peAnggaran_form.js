jun.peKasAwalStore = new Ext.data.JsonStore({
    root: "data",
    storeId: "pekasAwalStore",
    ...
    autoLoad: !1,
    autoSave: !1
}), jun.PeKasAwalGrid = Ext.extend(Ext.grid.GridPanel, {
    id: "docs-jun.PeKasAwalGrid",
    frameHeader: !1,
    header: !1,
    modal: !0,
    viewConfig: {
    ...
    initComponent: function() {
        this.store = jun.peKasAwalStore, this.store.on({
            load: {
                fn: function(a, b, c) {},
                scope: this
            },
        ...
        }), jun.PeKasAwalGrid.superclass.initComponent.call(this), this.store.load();
    },
    ...
    Ext.Ajax.request({
        url: "PondokEfata/PeAnggaran/IsPeriodeExist/",
        params: {
    ...
    Ext.Ajax.request({
        url: "PondokEfata/PeAnggaran/getSaldo/",
        params: {
            bulan: Ext.getCmp("periode_bulanid").getValue(),
            tahun: Ext.getCmp("periode_tahunid").getValue()
        },
        ...
        success: function(a, b) {
            ...
            Ext.get("totalangid").focus(), Ext.get("doc_refid").focus(), jun.rztPeAnggaranDetil.refreshData());
        },
        failure: function (f, a) {
                switch (a.failureType) {
                    case Ext.form.Action.CLIENT_INVALID:
...
}, jun.PeAnggaranWin = Ext.extend(Ext.Window, {
    title: "Anggaran",
    iconCls: "asp-pay",
    modez: 1,
    width: 621,
    ...
    initComponent: function() {
        ...
        }, jun.rztPeAnggaranDetil.removeAll(), jun.rztPeChartMaster.reload(), jun.PeAnggaranWin.superclass.initComponent.call(this), 
        ...
        if (this.modez == 1 || this.modez == 2) jun.rztPeAnggaranDetil.proxy = new Ext.data.HttpProxy({
            url: "PondokEfata/PeAnggaranDetil/index/id/" + this.id + "/?output=json"
        }), jun.rztPeAnggaranDetil.on({
            load: {
                fn: function(a, b, c) {
                    jun.rztPeAnggaranDetil.refreshData();
                }
            }
        }), jun.rztPeAnggaranDetil.load(), this.cmbBulan.readOnly = !0, this.periode_tahun.readOnly = !0;
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeAnggaran/update/id/" + this.id : (Ext.Ajax.request({
            url: "PondokEfata/PeAnggaran/IsPeriodeExist/",
            params: {
        ...
        }), a = "PondokEfata/PeAnggaran/create/"), Ext.getCmp("form-PeAnggaran").getForm().submit({
            url: a,
            params: {
                bulanStr: this.cmbBulan.getRawValue(),
                detil: Ext.encode(Ext.pluck(jun.rztPeAnggaranDetil.data.items, "data")),
                id: this.id
            },
            timeOut: 1e3,
            scope: this,
            success: function(a, b) {
                ...
                }), Ext.getCmp("form-PeAnggaran").getForm().reset(), this.btnDisabled(!1)), jun.rztPeAnggaran.reload(), 
                this.close();
            },
            failure: function (f, a) {
                switch (a.failureType) {
