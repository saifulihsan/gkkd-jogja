jun.PeLampiranGrid = Ext.extend(Ext.grid.GridPanel, {
    title: "Donasi Non Tunai",
    id: "docs-jun.PeLampiranGrid",
    iconCls: "silk-grid",
    viewConfig: {
        forceFit: !0
    },
    ...
    initComponent: function() {
        this.store = jun.rztPeLampiran, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPeLampiran.reload(), jun.PeLampiranGrid.superclass.initComponent.call(this), 
    ...
    loadEditForm: function() {
        ...
        var b = a.json.id_lampiran, c = new jun.PeLampiranWin({
            modez: 1,
            id: b
        });
    ...
    deleteRecYes: function(a) {
        ...
        Ext.Ajax.request({
            url: "PondokEfata/PeLampiran/delete/id/" + b.json.id_lampiran,
            method: "POST",
