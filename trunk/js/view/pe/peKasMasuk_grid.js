jun.PeKasMasukGrid = Ext.extend(Ext.grid.GridPanel, {
    title: "Daftar Kas Masuk",
    id: "docs-jun.PeKasMasukGrid",
    iconCls: "silk-grid",
    viewConfig: {
        forceFit: !0
    },
    ...
    initComponent: function() {
        this.store = jun.rztPeKasMasuk, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPeKasMasuk.reload(), jun.PeKasMasukGrid.superclass.initComponent.call(this), 
    ...
    loadEditForm: function() {
        ...
        var b = a.json.kas_masuk_id;
        Ext.Ajax.request({
            url: "PondokEfata/PeKasMasuk/view/",
            params: {
                id: b
            },
            method: "POST",
            success: function(a, c) {
                ...
                var e = d.data[0], f = new jun.PeKasMasukShowWin({
                    modez: 1,
                    id: b
                });
                f.txtRef.text = e.doc_ref, f.trans_entry.text = e.entry_time, f.no_bukti.text = e.no_bukti, 
                f.trans_date.text = e.trans_date, f.kas.text = e.bank_account_name, f.donatur.text = e.name, 
    ...
    deleteRec: function() {
        ...
        var b = new jun.PeKasMasukVoidWin({
            id: a.json.kas_masuk_id
        });
        b.show(this);
    }
});