jun.PeKasMasukGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    columns:[
        ...
        /*
         ...
         {
         header:'pe_donatur_id',
         sortable:true,
         resizable:true,
         dataIndex:'pe_donatur_id',
         width:100
         },
         {
    ...
    initComponent:function () {
        ...
        jun.PeKasMasukGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.PeKasMasukWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        Ext.Ajax.request({
            ...
            success:function (f, a) {
                ...
                var form = new jun.PeKasMasukShowWin({modez:1, id:idz});
    ...
    deleteRec:function () {
        ...
        var form = new jun.PeKasMasukVoidWin({id:record.json.kas_masuk_id});
        form.show(this);
            },
})
