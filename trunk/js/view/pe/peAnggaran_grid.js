...
//            ]
        ...
        jun.PeAnggaranGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.PeAnggaranWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        var form = new jun.PeAnggaranWin({modez:1, id:idz});
        form.show(this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            ...
            success:function (f, a) {
                ...
                Ext.MessageBox.show({
                    title:'Info',
                    msg:'Anggaran berhasil dihapus.' + response.msg,
