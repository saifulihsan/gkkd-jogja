jun.PeChartTypesWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeChartTypesWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeChartTypes/update/id/" + this.id : a = "PondokEfata/PeChartTypes/create/", 
        Ext.getCmp("form-PeChartTypes").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && Ext.getCmp("form-PeChartTypes").getForm().reset(), this.closeForm && this.close();
            },
