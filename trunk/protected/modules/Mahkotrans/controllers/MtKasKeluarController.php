	...
	public function actionCreate(){
		...
		if(isset($_POST)&&!empty($_POST)){
			...
			try{
				...
				$_POST['MtKasKeluar']['id_mobil']=is_integer($_POST['MtKasKeluar']['id_mobil'])?$_POST['MtKasKeluar']['id_mobil']:NULL;
		...
		if(isset($_POST)&&!empty($_POST)){
			...
			try{
				...
				Mt::add_gl(VOID,$void->id_voided,$date,$docref,$bank->account_code,
						"VOID Kas Keluar $docref",$kas_keluar->amount,$user,$kas_keluar->id_mobil);
