    ...
    public function actionCreate() {
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            try {
                ...
                $_POST['MtPinjamKendaraan']['id_driver'] = 
                        is_integer($_POST['MtPinjamKendaraan']['id_driver']) ? 
                        $_POST['MtPinjamKendaraan']['id_driver'] : NULL;
                ...
                if ($model->dp > 0) {
                    ...
                    Mt::add_gl(PINJAM_KENDARAAN, $model->id_pinjam, $date, $docref,
                            Mt::get_prefs('akun_penjualan'), '-', -$model->dp, $user);
                }
                $transaction->commit();
            } catch (Exception $ex) {
