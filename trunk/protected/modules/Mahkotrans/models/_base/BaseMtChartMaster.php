 ...
 * @property MtGlTrans[] $pahGlTrans
 * @property MtSubAktivitas[] $pahSubAktivitases
 */
abstract class BaseMtChartMaster extends GxActiveRecord
{
    ...
    {
        return array(
            'pahBankAccounts' => array(self::HAS_MANY, 'MtBankAccounts', 'account_code'),
            'accountType' => array(self::BELONGS_TO, 'MtChartTypes', 'account_type'),
            'pahGlTrans' => array(self::HAS_MANY, 'MtGlTrans', 'account'),
            'pahSubAktivitases' => array(self::HAS_MANY, 'MtSubAktivitas', 'account_code'),
        );
    }
