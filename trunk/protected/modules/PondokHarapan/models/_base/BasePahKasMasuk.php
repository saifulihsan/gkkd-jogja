...
abstract class BasePahKasMasuk extends GxActiveRecord
{
    ...
    {
        return array(
            array('pah_donatur_id, pah_chart_master_account_code, pah_bank_accounts_id, users_id', 'required'),
            ...
            array('kas_masuk_id, doc_ref, no_bukti, amount, entry_time, trans_date, trans_via, pah_donatur_id, pah_chart_master_account_code, pah_bank_accounts_id, users_id', 'safe', 'on' => 'search'),
        );
    }
