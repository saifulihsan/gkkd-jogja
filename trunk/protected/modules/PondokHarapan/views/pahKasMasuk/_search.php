<div class="wide form">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'kas_masuk_id'); ?>
        <?php echo $form->textField($model, 'kas_masuk_id'); ?>
    </div>
    <div class="span-8 last">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'pah_donatur_id'); ?>
        <?php echo $form->dropDownList($model, 'pah_donatur_id', GxHtml::listDataEx(PahDonatur::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
    </div>
    <div class="span-8 last">
