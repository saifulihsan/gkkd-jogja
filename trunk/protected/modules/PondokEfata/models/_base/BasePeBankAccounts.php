...
/**
 * This is the model base class for the table "pe_bank_accounts".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PeBankAccounts".
 *
 * Columns in table "pe_bank_accounts" available as properties of the model,
 * followed by relations of table "pe_bank_accounts" available as properties of the model.
 *
 * @property integer $id
 ...
 * @property PeBankTrans[] $peBankTrans
 * @property PeKasKeluar[] $peKasKeluars
 * @property PeKasMasuk[] $peKasMasuks
 */
abstract class BasePeBankAccounts extends GxActiveRecord
{
    ...
    {
        return array(
            'peAktivitases' => array(self::HAS_MANY, 'PeAktivitas', 'pe_bank_accounts_id'),
            'peAktivitasGrupTrans' => array(self::HAS_MANY, 'PeAktivitasGrupTrans', 'pe_bank_accounts_id'),
            'accountCode' => array(self::BELONGS_TO, 'PeChartMaster', 'account_code'),
            'peBankTrans' => array(self::HAS_MANY, 'PeBankTrans', 'bank_act'),
            'peKasKeluars' => array(self::HAS_MANY, 'PeKasKeluar', 'pe_bank_accounts_id'),
            'peKasMasuks' => array(self::HAS_MANY, 'PeKasMasuk', 'pe_bank_accounts_id'),
        );
    }
