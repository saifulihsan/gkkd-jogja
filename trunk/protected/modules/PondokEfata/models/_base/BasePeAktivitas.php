...
/**
 * This is the model base class for the table "pe_aktivitas".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PeAktivitas".
 *
 * Columns in table "pe_aktivitas" available as properties of the model,
 * followed by relations of table "pe_aktivitas" available as properties of the model.
 *
 ...
 * @property PeMember $peMember
 * @property PeSubAktivitas $peSubAktivitas
 * @property Users $users
 */
abstract class BasePeAktivitas extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('pe_supplier_id, pe_bank_accounts_id, pe_member_id, pe_sub_aktivitas_id, users_id', 'required'),
			array('pe_supplier_id, pe_bank_accounts_id, pe_member_id, pe_sub_aktivitas_id, users_id', 'numerical', 'integerOnly'=>true),
			...
			array('aktivitas_id, doc_ref, no_bukti, amount, entry_time, trans_date, trans_via, pe_supplier_id, pe_bank_accounts_id, pe_member_id, pe_sub_aktivitas_id, users_id, note', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations() {
		return array(
			...
			'peMember' => array(self::BELONGS_TO, 'PeMember', 'pe_member_id'),
	...
	public function attributeLabels() {
		return array(
			...
			'pe_member_id' => Yii::t('app', 'Pe Member'),
	...
	public function search() {
		...
		$criteria->compare('pe_member_id', $this->pe_member_id);
