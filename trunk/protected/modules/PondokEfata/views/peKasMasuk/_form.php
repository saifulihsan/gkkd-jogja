<div class="wide form">
    ...
    <!-- row -->
    <div class="span-8 last">
        <?php echo $form->labelEx($model, 'pe_donatur_id'); ?>
        <?php echo $form->dropDownList($model, 'pe_donatur_id', GxHtml::listDataEx(PeDonatur::model()->findAllAttributes(null, true))); ?>
        <?php echo $form->error($model, 'pe_donatur_id'); ?>
    </div>
    <!-- row -->
    <div class="span-8 last">
