...
$this->menu = array(
    array('label' => Yii::t('app', 'List') . ' PeBankAccounts',
        'url' => array('index')),
    array('label' => Yii::t('app', 'Create') . ' PeBankAccounts',
        'url' => array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('pe-bank-accounts-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('app', 'Manage'); ?> Pe Bank Accounts</h1>
