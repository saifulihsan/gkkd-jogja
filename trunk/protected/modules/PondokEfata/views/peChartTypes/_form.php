<div class="wide form">
    ...
    <div class="span-8 last">
        ...
        <?php echo $form->dropDownList($model, 'class_id', GxHtml::listDataEx(PeChartClass::model()->findAllAttributes(null, true))); ?>
    ...
    echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
        'submit' => array('pecharttypes/admin')
    ));
