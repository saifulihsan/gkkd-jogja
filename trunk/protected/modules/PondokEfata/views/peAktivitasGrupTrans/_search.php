<div class="wide form">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'pe_aktivitas_grup_id'); ?>
        <?php echo $form->dropDownList($model, 'pe_aktivitas_grup_id', GxHtml::listDataEx(PeAktivitasGrup::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
    </div>
    <div class="span-8 last">
