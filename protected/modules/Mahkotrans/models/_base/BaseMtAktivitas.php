...
/**
 * This is the model base class for the table "mt_aktivitas".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "MtAktivitas".
 *
 * Columns in table "mt_aktivitas" available as properties of the model,
 * followed by relations of table "mt_aktivitas" available as properties of the model.
 *
...
abstract class BaseMtAktivitas extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('mt_suppliers_supplier_id, mt_bank_accounts_id, mt_member_id, mt_sub_aktivitas_id, users_id', 'required'),
			array('mt_suppliers_supplier_id, mt_bank_accounts_id, mt_member_id, mt_sub_aktivitas_id, users_id', 'numerical', 'integerOnly'=>true),
			...
			array('aktivitas_id, doc_ref, no_bukti, amount, entry_time, trans_date, trans_via, mt_suppliers_supplier_id, mt_bank_accounts_id, mt_member_id, mt_sub_aktivitas_id, users_id, note', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations() {
		return array(
			...
			'pahMember' => array(self::BELONGS_TO, 'MtMember', 'mt_member_id'),
	...
	public function attributeLabels() {
		return array(
			...
			'mt_member_id' => Yii::t('app', 'Mt Member'),
	...
	public function search() {
		...
		$criteria->compare('mt_member_id', $this->mt_member_id);
