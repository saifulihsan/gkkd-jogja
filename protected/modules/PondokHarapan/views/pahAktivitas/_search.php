<div class="wide form">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'pah_member_id'); ?>
        <?php echo $form->dropDownList($model, 'pah_member_id', GxHtml::listDataEx(PahMember::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
    </div>
    <div class="span-8 last">
