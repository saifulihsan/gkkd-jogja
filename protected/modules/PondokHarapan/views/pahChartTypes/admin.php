...
$this->menu = array(
    array('label' => Yii::t('app', 'List') . ' PahChartTypes',
        'url' => array('index')),
    array('label' => Yii::t('app', 'Create') . ' PahChartTypes',
        'url' => array('create')),
);
...
<h1><?php echo Yii::t('app', 'Manage'); ?> Pah Chart Types</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'filter' => GxHtml::listDataEx(PahChartClass::model()->findAllAttributes(null, true)),
        ),
        'parent',
        array(
            'name' => 'inactive',
