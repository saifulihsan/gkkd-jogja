...
$this->menu = array(
    array('label' => Yii::t('app', 'List') . ' PahKasMasuk',
        'url' => array('index')),
    array('label' => Yii::t('app', 'Create') . ' PahKasMasuk',
        'url' => array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('pah-kas-masuk-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('app', 'Manage'); ?> Pah Kas Masuks</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
                'name'=>'pah_donatur_id',
                'value'=>'GxHtml::valueEx($data->pahDonatur)',
                'filter'=>GxHtml::listDataEx(PahDonatur::model()->findAllAttributes(null, true)),
                ),
        array(
