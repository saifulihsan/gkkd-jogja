...
; ?>
	...
	<div class="span-8 last">
		<?php echo $form->label($model, 'pah_aktivitas_grup_id'); ?>
		<?php echo $form->dropDownList($model, 'pah_aktivitas_grup_id', GxHtml::listDataEx(PahAktivitasGrup::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="span-8 last">
		<?php echo $form->label($model, 'pah_sub_aktivitas_id'); ?>
		<?php echo $form->dropDownList($model, 'pah_sub_aktivitas_id', GxHtml::listDataEx(PahSubAktivitas::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
