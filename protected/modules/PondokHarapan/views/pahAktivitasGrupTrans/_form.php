...
<?php $form = $this->beginWidget('GxActiveForm', array(
	'id' => 'pah-aktivitas-grup-trans-form',
...
; ?>
		...
		<div class="span-8 last">
		<?php echo $form->labelEx($model,'pah_aktivitas_grup_id'); ?>
		<?php echo $form->dropDownList($model, 'pah_aktivitas_grup_id', GxHtml::listDataEx(PahAktivitasGrup::model()->findAllAttributes(null, true))); ?>
		<?php echo $form->error($model,'pah_aktivitas_grup_id'); ?>
		</div><!-- row -->
		<div class="span-8 last">
...
echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
			'submit' => array('pahaktivitasgruptrans/admin')
		));
