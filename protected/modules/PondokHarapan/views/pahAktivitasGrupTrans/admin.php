...
$this->menu = array(
		array('label'=>Yii::t('app', 'List') . ' PahAktivitasGrupTrans',
			'url'=>array('index')),
		array('label'=>Yii::t('app', 'Create') . ' PahAktivitasGrupTrans',
		'url'=>array('create')),
	);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('pah-aktivitas-grup-trans-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('app', 'Manage'); ?> Pah Aktivitas Grup Trans</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id' => 'pah-aktivitas-grup-trans-grid',
	...
	'columns' => array(
		...
		array(
				...
				'value'=>'GxHtml::valueEx($data->pahAktivitasGrup)',
				'filter'=>GxHtml::listDataEx(PahAktivitasGrup::model()->findAllAttributes(null, true)),
				),
		array(
