...
/**
 * This is the model base class for the table "pe_suppliers".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PeSuppliers".
 *
 * Columns in table "pe_suppliers" available as properties of the model,
 * followed by relations of table "pe_suppliers" available as properties of the model.
 *
 ...
 */
abstract class BasePeSuppliers extends GxActiveRecord
{
    ...
    {
        return array(
            'peAktivitases' => array(self::HAS_MANY, 'PeAktivitas', 'pe_supplier_id'),
            'peAktivitasGrupTrans' => array(self::HAS_MANY, 'PeAktivitasGrupTrans', 'pe_supplier_id'),
            'peKasKeluars' => array(self::HAS_MANY, 'PeKasKeluar', 'pe_supplier_id'),
        );
    }
