...
/**
 * This is the model base class for the table "pe_gl_trans".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PeGlTrans".
 *
 * Columns in table "pe_gl_trans" available as properties of the model,
 * followed by relations of table "pe_gl_trans" available as properties of the model.
 *
 ...
 *
 * @property PeChartMaster $account0
 */
abstract class BasePeGlTrans extends GxActiveRecord
{
    ...
    {
        return array(
            'account0' => array(self::BELONGS_TO, 'PeChartMaster', 'account'),
        );
    }
