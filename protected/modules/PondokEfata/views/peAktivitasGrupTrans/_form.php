<div class="wide form">
    ...
    'id' => 'pe-aktivitas-grup-trans-form',
    ...
    <!-- row -->
    <div class="span-8 last">
        <?php echo $form->labelEx($model, 'pe_aktivitas_grup_id'); ?>
        <?php echo $form->dropDownList($model, 'pe_aktivitas_grup_id', GxHtml::listDataEx(PeAktivitasGrup::model()->findAllAttributes(null, true))); ?>
        <?php echo $form->error($model, 'pe_aktivitas_grup_id'); ?>
    </div>
    <!-- row -->
    <div class="span-8 last">
        <?php echo $form->labelEx($model, 'pe_sub_aktivitas_id'); ?>
        <?php echo $form->dropDownList($model, 'pe_sub_aktivitas_id', GxHtml::listDataEx(PeSubAktivitas::model()->findAllAttributes(null, true))); ?>
        <?php echo $form->error($model, 'pe_sub_aktivitas_id'); ?>
    </div>
    <!-- row -->
    <!-- june -->
    <div class="row"></div>
    ...
    echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
        'submit' => array('peaktivitasgruptrans/admin')
    ));
