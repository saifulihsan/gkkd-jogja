...
$this->menu = array(
    array('label' => Yii::t('app', 'List') . ' PeSubAktivitas',
        'url' => array('index')),
    array('label' => Yii::t('app', 'Create') . ' PeSubAktivitas',
        'url' => array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('pe-sub-aktivitas-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('app', 'Manage'); ?> Pe Sub Aktivitases</h1>
