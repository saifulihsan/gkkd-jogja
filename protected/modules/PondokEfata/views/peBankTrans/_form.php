<div class="wide form">
    ...
    <div class="span-8 last">
        ...
        <?php echo $form->dropDownList($model, 'bank_act', GxHtml::listDataEx(PeBankAccounts::model()->findAllAttributes(null, true))); ?>
    ...
    echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
        'submit' => array('pebanktrans/admin')
    ));
