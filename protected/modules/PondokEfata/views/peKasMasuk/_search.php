<div class="wide form">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'pe_donatur_id'); ?>
        <?php echo $form->dropDownList($model, 'pe_donatur_id', GxHtml::listDataEx(PeDonatur::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
    </div>
    <div class="span-8 last">
