<div class="wide form">
    ...
    <div class="span-8 last">
        <?php echo $form->label($model, 'pe_account_code'); ?>
        <?php echo $form->dropDownList($model, 'pe_account_code', GxHtml::listDataEx(PeChartMaster::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
    </div>
    <div class="span-8 last">
