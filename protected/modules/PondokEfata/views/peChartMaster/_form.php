<div class="wide form">
    ...
    <div class="span-8 last">
        ...
        <?php echo $form->dropDownList($model, 'account_type', GxHtml::listDataEx(PeChartTypes::model()->findAllAttributes(null, true))); ?>
    ...
    echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
        'submit' => array('pechartmaster/admin')
    ));
