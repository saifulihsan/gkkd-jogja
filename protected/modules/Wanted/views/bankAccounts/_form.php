...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'account_code', GxHtml::listDataEx(ChartMaster::model()->findAllAttributes(null, true))); ?>
		...
		<?php echo $form->checkBox($model, 'dflt_curr_act'); ?>
...
echo GxHtml::Button(Yii::t('app', 'Cancel'), array(
			'submit' => array('bankaccounts/admin')
		));
