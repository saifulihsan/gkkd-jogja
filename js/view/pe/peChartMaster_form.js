jun.PeChartMasterWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeChartMasterWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeChartMaster/update/id/" + this.id : a = "PondokEfata/PeChartMaster/create/", 
        Ext.getCmp("form-PeChartMaster").getForm().submit({
            ...
            success: function(a, b) {
                ...
                this.modez == 0 && Ext.getCmp("form-PeChartMaster").getForm().reset(), this.btnDisabled(!1));
            },
    ...
    initComponent: function() {
        ...
        }, jun.rztPeChartMaster.reload(), jun.PeSaldoAwalWin.superclass.initComponent.call(this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0), Ext.getCmp("form-PeSaldoAwal").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), Ext.getCmp("form-PeSaldoAwal").getForm().reset(), this.close();
            },
            failure: function (f, a) {
                switch (a.failureType) {
                    case Ext.form.Action.CLIENT_INVALID:
