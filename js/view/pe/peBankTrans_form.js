jun.PeTranferBankWin = Ext.extend(Ext.Window, {
    ...
    initComponent:function () {
        ...
        jun.PeTranferBankWin.superclass.initComponent.call(this);
    ...
    saveForm:function () {
        ...
        var urlz;
        urlz = 'PondokEfata/PeBankTrans/createtransfer/';
        Ext.getCmp('pe-form-Transfer-bank').getForm().submit({
            url:urlz,
            /*
             params:{
            ...
            success:function (f, a) {
                ...
                if (response.success == false) {
                    ...
                    Ext.getCmp('pe-form-Transfer-bank').getForm().reset();
                }
