jun.PeSuppliersWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeSuppliersWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeSuppliers/update/id/" + this.id : a = "PondokEfata/PeSuppliers/create/", 
        Ext.getCmp("form-PeSuppliers").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && (Ext.getCmp("form-PeSuppliers").getForm().reset(), this.btnDisabled(!1)), 
