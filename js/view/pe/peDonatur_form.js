jun.PeDonaturWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.rztPeChartMaster.reload(), jun.PeDonaturWin.superclass.initComponent.call(this), 
    ...
    saveForm: function() {
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeDonatur/update/id/" + this.id : a = "PondokEfata/PeDonatur/create/", 
        Ext.getCmp("form-PeDonatur").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && Ext.getCmp("form-PeDonatur").getForm().reset(), this.closeForm && this.close();
            },
