jun.PeAktivitasWin = Ext.extend(Ext.Window, {
    ...
    initComponent:function () {
        ...
        jun.PeAktivitasWin.superclass.initComponent.call(this);
    ...
    onWinClose:function () {
        ...
        jun.rztPeMemberbyName.clearFilter();
    ...
    saveForm:function () {
        ...
        if (this.modez == 1 || this.modez == 2) {
            urlz = 'PondokEfata/PeAktivitas/update/id/' + this.id;
        } else {
            urlz = 'PondokEfata/PeAktivitas/create/';
        }
        Ext.getCmp('form-PeAktivitas').getForm().submit({
            ...
            success:function (f, a) {
                ...
                if (this.modez == 0) {
                    Ext.getCmp('form-PeAktivitas').getForm().reset();
                }
                if (this.closeForm) {
                    this.close();
                }
...
jun.PeAktivitasShowWin = Ext.extend(Ext.Window, {
    ...
    initComponent:function () {
        ...
        jun.PeAktivitasShowWin.superclass.initComponent.call(this);
        this.btnCancel.on('click', this.onbtnCancelclick, this);
    },
    onbtnCancelclick:function () {
        this.close();
...
jun.PeAktivitasVoidWin = Ext.extend(Ext.Window, {
    ...
    initComponent:function () {
        ...
        jun.PeAktivitasVoidWin.superclass.initComponent.call(this);
    ...
    onbtnProsesclick:function () {
        this.btnDisabled(true);
        var form = Ext.getCmp('form-PeAktivitasVoid').getForm();
        Ext.getCmp('form-PeAktivitasVoid').getForm().submit({
            ...
            success:function (f, a) {
                ...
                if (response.success == false) {
                    ...
                    Ext.getCmp('form-PeAktivitasVoid').getForm().reset();
                }
                this.btnDisabled(false);
                jun.rztPeAktivitas.reload();
                this.close();
