jun.PeLampiranWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeLampiranWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeLampiran/update/id/" + this.id : a = "PondokEfata/PeLampiran/create/", 
        Ext.getCmp("form-PeLampiran").getForm().submit({
            url: a,
            timeOut: 1e3,
            scope: this,
            success: function(a, b) {
                jun.rztPeLampiran.reload();
                ...
                }), this.modez == 0 && (Ext.getCmp("form-PeLampiran").getForm().reset(), this.btnDisabled(!1)), 
