jun.PeAktivitasGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPeAktivitas, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPeAktivitas.reload(), jun.rztPeSuppliers.reload(), jun.rztPeMemberbyName.reload(), 
        jun.rztPeSubAktivitas.reload(), jun.rztPeChartMaster.reload(), jun.PeAktivitasGrid.superclass.initComponent.call(this), 
    ...
    loadEditForm: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(a, c) {
                ...
                var e = d.data[0], f = new jun.PeAktivitasShowWin({
                    modez: 1,
                    id: b
                });
    ...
    deleteRec: function() {
        ...
        var b = new jun.PeAktivitasVoidWin({
