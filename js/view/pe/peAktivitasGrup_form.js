jun.PeAktivitasGrupWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.PeAktivitasGrupWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokEfata/PeAktivitasGrup/update/id/" + this.id : a = "PondokEfata/PeAktivitasGrup/create/", 
        Ext.getCmp("form-PeAktivitasGrup").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && (Ext.getCmp("form-PeAktivitasGrup").getForm().reset(), this.btnDisabled(!1)), 
