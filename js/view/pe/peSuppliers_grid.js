...
//                }
        ...
        jun.PeSuppliersGrid.superclass.initComponent.call(this);
...
//        this.btnDelete.on('Click', this.deleteRec, this);
    ...
    loadForm:function () {
        var form = new jun.PeSuppliersWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        var form = new jun.PeSuppliersWin({modez:1, id:idz});
        form.show(this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            url:'PondokEfata/PeSuppliers/delete/id/' + record.json.supplier_id,
            method:'POST',
