jun.PeKasKeluarGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Pengeluaran Kas Umum",
    id:'docs-jun.PeKasKeluarGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
...
//        },
    ...
    initComponent:function () {
        ...
        jun.PeKasKeluarGrid.superclass.initComponent.call(this);
    ...
    loadForm:function () {
        var form = new jun.PeKasKeluarWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        Ext.Ajax.request({
            //
            url:'PondokEfata/PeKasKeluar/view/',
            params:{
                id:idz,
            },
            method:'POST',
            success:function (f, a) {
                ...
                var form = new jun.PeKasKeluarShowWin({modez:1, id:idz});
    ...
    deleteRec:function () {
        ...
        var form = new jun.PeKasKeluarVoidWin({id:record.json.kas_keluar_id});
        form.show(this);
            },
})
