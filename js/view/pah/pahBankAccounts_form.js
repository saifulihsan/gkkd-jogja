jun.PahBankAccountsWin = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        }, jun.rztPahChartMaster.reload(), jun.PahBankAccountsWin.superclass.initComponent.call(this), 
    ...
    saveForm: function() {
        this.btnDisabled(!0);
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokHarapan/PahBankAccounts/update/id/" + this.id : a = "PondokHarapan/PahBankAccounts/create/", 
        Ext.getCmp("form-PahBankAccounts").getForm().submit({
            ...
            success: function(a, b) {
                ...
                }), this.modez == 0 && Ext.getCmp("form-PahBankAccounts").getForm().reset(), jun.rztPahBankAccounts.reload(), 
