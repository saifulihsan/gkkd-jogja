jun.PahSysWin = Ext.extend(Ext.Window, {
    title: "Setting",
    modez: 1,
    width: 400,
    height: 200,
    ...
    initComponent: function() {
        ...
        }, jun.PahSysWin.superclass.initComponent.call(this), this.on("activate", this.onActivate, this), 
    ...
    saveForm: function() {
        var a;
        this.modez == 1 || this.modez == 2 ? a = "PondokHarapan/PahSys/update/id/" + this.id : a = "PondokHarapan/PahSys/create/", 
        Ext.getCmp("form-PahSys").getForm().submit({
            ...
            success: function(a, b) {
                ...
                this.modez == 0 && Ext.getCmp("form-PahSys").getForm().reset());
            },
