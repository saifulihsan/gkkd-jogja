jun.PahKasMasukGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent: function() {
        this.store = jun.rztPahKasMasuk, this.bbar = {
            items: [ {
                xtype: "paging",
                store: this.store,
                displayInfo: !0,
        ...
        }, jun.rztPahKasMasuk.load(), jun.PahKasMasukGrid.superclass.initComponent.call(this), 
    ...
    loadEditForm: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(a, c) {
                ...
                var e = d.data[0], f = new jun.PahKasMasukShowWin({
                    modez: 1,
                    id: b
                });
    ...
    deleteRec: function() {
        ...
        var b = new jun.PahKasMasukVoidWin({
