...
//}
jun.MtPengembalianGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Pengembalian Kendaraan",
    id:'docs-jun.MtPengembalianGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
    ...
    initComponent:function () {
        ...
        this.store = jun.rztMtPengembalian;
//        this.bbar = {
//            items:[
//                {
//                    xtype:'paging',
...
//        };
        this.tbar = {
            ...
            items:[
                {
                    xtype:'button',
                    text:'Tambah Pengembalian Kendaraan',
                    ref:'../btnAdd'
                },
                {
                    xtype:'tbseparator',
                ...
                {
                    xtype:'button',
                    text:'Ubah Pengembalian Kendaraan',
                    ref:'../btnEdit'
                },
//                {
//                    xtype:'tbseparator',
...
//        jun.rztMtChartTypes.reload();
        jun.rztMtPengembalian.reload();
        jun.MtPengembalianGrid.superclass.initComponent.call(this);
...
//        var selectedz = this.sm.getSelections();
    ...
    loadEditForm:function () {
        ...
        var form = new jun.MtPengembalianWin({modez:1, id:idz});
        form.show(this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            url:'Mahkotrans/MtPengembalian/delete/id/' + record.json.account_code,
