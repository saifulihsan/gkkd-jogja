jun.MtAnggaranGrid = Ext.extend(Ext.grid.GridPanel, {
    title:"Anggaran",
    id:'docs-jun.MtAnggaranGrid',
    iconCls: 'silk-grid',
    viewConfig:{
        forceFit:true,
    },
...
//        };
        ...
        jun.MtAnggaranGrid.superclass.initComponent.call(this);
        this.btnAdd.on('Click', this.loadForm, this);
        this.btnEdit.on('Click', this.loadEditForm, this);
        this.btnDelete.on('Click', this.deleteRec, this);
        this.getSelectionModel().on('rowselect', this.getrow, this);
        jun.rztMtAnggaran.load();
    },
    ...
    loadForm:function () {
        var form = new jun.MtAnggaranWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        var form = new jun.MtAnggaranWin({modez:1, id:idz});
        form.show(this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            url:'Mahkotrans/MtAnggaran/delete',
            //url:'Mahkotrans/MtAnggaran/delete/id/' + record.json.id,
            method:'POST',
            params:{
