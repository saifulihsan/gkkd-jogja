jun.MtBankTransGrid = Ext.extend(Ext.grid.GridPanel, {
    ...
    loadForm:function () {
        var form = new jun.MtBankTransWin({modez:0});
        form.show();
    },
    loadEditForm:function () {
        ...
        var form = new jun.MtBankTransWin({modez:1, id:idz});
        form.show(this);
    ...
    deleteRecYes:function (btn) {
        ...
        Ext.Ajax.request({
            waitMsg:'Please Wait',
            url:'Mahkotrans/MtBankTrans/delete/id/' + record.json.id,
            //url: 'index.php/api/MtBankTrans/delete/' + record[0].json.nosjp,
            method:'POST',
